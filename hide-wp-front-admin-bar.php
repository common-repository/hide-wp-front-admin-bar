...
class HIDE_WP_FRONT_ADMIN_BAR{
    ...
    public function applyActions($action,$data){
        ...
        if($action == 'HIDE_WP_FRONT_ADMIN_BAR'){
            ...
            if(get_option('_hide_admin_bar_settings') && update_option('_hide_admin_bar_settings',serialize($_hide_admin_bar_settings))){
                return array('status'=>true,'msg'=>"Admin Bar settings have been saved successfully.");
            }    
            elseif(get_option('_hide_admin_bar_settings',serialize($_hide_admin_bar_settings))){
                return array('status'=>true,'msg'=>"Admin Bar settings have been saved successfully.");
            }    
            else{
